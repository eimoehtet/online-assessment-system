...
const StudentResultDetail = () => {
  ...
  if (!submission) return <div className="rounded-lg border border-red-200 bg-red-50 p-4 text-red-700">{error || 'Result not found.'}</div>;
  ...
  return <div className="mx-auto max-w-5xl">
    ...
    {!released && <div className="mb-6 rounded-xl border border-amber-200 bg-amber-50 p-5 text-amber-900"><h2 className="font-semibold">Your quiz was submitted successfully</h2><p className="mt-1 text-sm">Your teacher is reviewing this attempt. Scores, correctness, and feedback will appear after the result is released.</p></div>}
