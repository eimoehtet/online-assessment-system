...
const StudentResultDetail = () => {
  ...
  return <div className="mx-auto max-w-5xl">
    ...
    {!released && <Alert variant="info" title="Your quiz was submitted successfully" className="mb-6">Your teacher is reviewing this attempt. Scores, correctness, and feedback will appear after the result is released.</Alert>}
