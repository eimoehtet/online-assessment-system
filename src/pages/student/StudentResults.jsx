...
const StudentResults = () => {
  ...
  return <div className="mx-auto max-w-6xl">
    ...
    {error && <Alert className="mb-4"><div className="flex items-center justify-between gap-3"><span>{error}</span><button onClick={load} className="font-semibold underline">Retry</button></div></Alert>}
